...
\date{\today\xspace | \href{https://www.someconference.com}{Some conference}}
...
\begin{frame}
	...
	With some text
\end{frame}
\note{Here's a note, which does not show up on the slides, but in the printout, if you want.}

\begin{frame}
	\frametitle{Done!}
	\begin{itemize}
		\item This was very important
		\item Thanks for the fish!
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{itemize}
			...
			\end{itemize}
			\item Lab technicians
			\begin{itemize}
				\item<1-> Regula Buergy, Eveline Yao
			\end{itemize}
			\item SNF
...
\begin{frame}
	\frametitle{Colophon}
	\begin{itemize}
		\item \href{https://github.com/habi/MyUnibeTalk}{The presentation (\LaTeX/\textsc{beamer}) is available on GitHub}: git.io/fjpwb
