...
--(axis cs:1.004,0.0314)
--cycle;
\addplot [only marks, draw=white!85.09803921568627!black, fill=white!85.09803921568627!black, colormap/blackwhite]
table{%
x                      y
};
\addlegendentry{Control}
\addplot [only marks, draw=color0, fill=color0, colormap/blackwhite]
table{%
x                      y
};
...
\addplot [only marks, draw=black, fill=white!85.09803921568627!black, colormap/blackwhite, forget plot]
table{%
x                      y
...
\addplot [only marks, draw=black, fill=color0, colormap/blackwhite, forget plot]
table{%
x                      y
