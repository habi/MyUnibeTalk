...
\defbeamertemplate{footline}{unibe}{%
	\hspace*{\fill}%
	page\xspace\insertframenumber\xspace of \inserttotalframenumber\xspace from version \href{https://github.com/habi/20190605_BrukerUserMeeting/commit/\gitHash}{\gitAbbrevHash}%
	\hspace*{4ex}%
	\vskip2pt%
}
