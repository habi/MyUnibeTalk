...
\begin{frame}
	...
	\def\shadow{4}% shadow parameter for scalebar	
	\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
		\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includemedia[width=0.618\linewidth]{\includegraphics{./mov/fishvideo/fishvideo_0001}}{./mov/fishvideo/fishvideo.mp4}};
		\draw[|-|,thick] (\x+\shadow,\y+\shadow) -- (\x+301+\shadow,\y+\shadow) node {\SI{500}{\micro\meter}};
		\draw[|-|,white,thick] (\x,\y) -- (\x+301,\y) node [midway,above] {\SI{500}{\micro\meter}};
	\end{tikzpicture}%
\end{frame}
