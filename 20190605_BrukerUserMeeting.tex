...
\begin{frame}[label=current]
	...
	\begin{itemize}
		...
		\item<2-> Lungs? \only<3->{Unclear results}
		\item<4-> Zebrafish \only<5->{\faHands}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\includegraphics<1>[height=\textheight]{./img/Control03_rec00001865}
	\includegraphics<2>[height=\textheight]{./img/control03_rec0000_voi_1865}
	\includegraphics<3>[height=\textheight]{./img/Control03_thresholded_1500}
	\only<4>{\include{./img/Gillvolume}}
\end{frame}
...
\begin{frame}
	\frametitle{Gill complexity}
	\includegraphics<1>[height=\textheight]{./img/Control03_thresholded_1500}
	\includegraphics<2>[height=\textheight]{./img/control03_rec0000_voi_1865}
	\only<3>{\include{./img/Gills_per_organ}}
\end{frame}
