...
\begin{frame}
	\frametitle{EM}
	\includegraphics<1>[width=\linewidth]{./img/Filament_length}
\end{frame}

\begin{frame}
	\frametitle{Gill volume}
	\includegraphics<1>[width=\linewidth]{./img/Gillvolume}
\end{frame}

\begin{frame}
	\frametitle{Gill complexity}
	\includegraphics<1>[width=\linewidth]{./img/Gills_per_organ_average_slices_from3062slices}
\end{frame}

\begin{frame}
	\frametitle{\ce{O2} consumption}
	\includegraphics<1>[width=\linewidth]{./img/O2_normalized}
\end{frame}
